  ...
  return(
    <div id="right-sidebar" className="animated">
        ...
        <div className="tab-content">
          ...
          <div className="slimScrollBar" style={{'background': 'rgb(0, 0, 0)', 'width': '7px', 'position': 'absolute', 'top': '222px', 'opacity':' 0.4', 'display':' none', 'borderRadius': '7px' ,'zIndex':' 99' ,'right':' 1px' ,'height':'392.704px'}}></div>
          <div className="slimScrollRail" style={{'width': '7px', 'height': '100%', 'position': 'absolute' ,'top': '0px' ,'display':'none' ,'borderRadius': '7px', 'background': 'rgb(51, 51, 51)', 'opacity':' 0.4', 'zIndex': '90', 'right': '1px'}}></div>
        </div>
      </div>
    )
  }
